...
EXAMS = [
  ...
  # ── 위험물산업기사 ───────────────────────────────────────
  {
    ...
    "badges":   ["🧪 위험물산업기사", "📋 60문항 · 4과목", "⏱ 120분", "✅ 평균 60점 합격"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
  ...
  # ── 공인중개사 ───────────────────────────────────────────
  {
    ...
    "count":    80,
    "icon":     "🏠",
    "title":    "공인중개사 1차 필기 무료 모의고사 – 80문항 2과목",
    "desc":     "공인중개사 1차 시험 무료 모의고사. 회원가입 없이 즉시 시작, 부동산학개론·민법 2과목, 기출문제 기반, 오답노트 제공.",
    "h1":       "공인중개사 1차 필기 모의고사",
  ...
  },
  {
    ...
    "count":    120,
    "icon":     "🏠",
    "title":    "공인중개사 2차 필기 무료 모의고사 – 120문항 3과목",
    "desc":     "공인중개사 2차 시험 무료 모의고사. 회원가입 없이 즉시 시작, 공인중개사법·부동산공법·부동산공시법 3과목, 기출문제 기반, 오답노트 제공.",
    "h1":       "공인중개사 2차 필기 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-realtor-2.html",
    "badges":   ["🏠 공인중개사 2차", "📋 120문항 · 3과목", "⏱ 120분", "✅ 과목 평균 60점 합격"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
  ...
  # ── 사회복지사 1급 ───────────────────────────────────────
  {
    ...
    "count":    50,
    "icon":     "👐",
    "title":    "사회복지사 1급 1교시 무료 모의고사 – 50문항",
    "desc":     "사회복지사 1급 1교시 무료 모의고사. 회원가입 없이 즉시 시작, 사회복지기초(사회복지학개론·인간행동과사회환경) 기출문제 기반, 오답노트 제공.",
  ...
  },
  {
    ...
    "count":    75,
    "icon":     "👐",
    "title":    "사회복지사 1급 2교시 무료 모의고사 – 75문항",
    "desc":     "사회복지사 1급 2교시 무료 모의고사. 회원가입 없이 즉시 시작, 사회복지실천(사회복지실천론·기술론·가족복지론 등) 기출문제 기반, 오답노트 제공.",
  ...
  },
  {
    ...
    "count":    75,
    "icon":     "👐",
    "title":    "사회복지사 1급 3교시 무료 모의고사 – 75문항",
    "desc":     "사회복지사 1급 3교시 무료 모의고사. 회원가입 없이 즉시 시작, 사회복지정책과제도(사회보장론·사회복지법제 등) 기출문제 기반, 오답노트 제공.",
  ...
  },
  {
    ...
    "badges":   ["⛑️ 산업안전기사", "📋 120문항 · 5과목", "⏱ 180분", "✅ 평균 60점 합격"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>1과목</th><td>산업안전관리론 (30문항)</td></tr>
          <tr><th>2과목</th><td>인간공학 및 시스템안전공학 (20문항)</td></tr>
          <tr><th>3과목</th><td>기계·기구 및 설비 안전관리 (20문항)</td></tr>
          <tr><th>4과목</th><td>전기설비 안전관리 (20문항)</td></tr>
          <tr><th>5과목</th><td>건설안전기술 (30문항)</td></tr>
    ...
    "faq": [
      ("산업안전기사 필기 합격 기준은?", "5과목 각각 40점 이상이면서 전과목 평균 60점 이상이어야 합격합니다. 한 과목이라도 40점 미만이면 과락 처리됩니다."),

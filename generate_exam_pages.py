...
ERROR_PREVENTION_TAG = Path(r"C:\개인\wooahouse\error_prevention_tag.txt").read_text(encoding="utf-8").rstrip("\n")
...
EXAMS = [
  ...
  # ── TOPIK Ⅰ (한국어능력시험 초급) ───────────────────────
  {
    "file":     "exam-topik-1.html",
    "type":     "topik_1",
    "label":    "TOPIK Ⅰ",
    "count":    37,
    "icon":     "🇰🇷",
    "title":    "TOPIK Ⅰ 한국어능력시험 읽기 무료 모의고사 – 기출 37문항",
    "desc":     "TOPIK Ⅰ(한국어능력시험 초급) 읽기 영역 무료 모의고사. 회원가입 없이 즉시 시작, 국립국제교육원 공식 기출문제(37~102회) 기반, 오답노트 제공.",
    "h1":       "TOPIK Ⅰ 읽기 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-topik-1.html",
    "badges":   ["🇰🇷 TOPIK Ⅰ", "📋 37문항 · 읽기", "⏱ 46분", "🏅 1~2급"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>TOPIK Ⅰ 읽기 영역 (초급)</td></tr>
          <tr><th>문항 수</th><td>37문항 (4지선다, 그림 문제 일부 제외)</td></tr>
          <tr><th>급수 기준</th><td>1급: 80점↑ / 2급: 140점↑ (200점 만점, 듣기+읽기 합산)</td></tr>
          <tr><th>주관</th><td>국립국제교육원(NIIED)</td></tr>
          <tr><th>문제 출처</th><td>TOPIK 공식 기출문제 연습 서비스(37·41·47·52·60·64·83·91·96·102회)</td></tr>
        </table>
      </div>""",
    "faq": [
      ("이 모의고사로 실제 등급을 알 수 있나요?", "이 모의고사는 읽기 영역만 다룹니다. 실제 TOPIK Ⅰ 등급은 듣기 영역과 합산한 점수(200점 만점)로 결정되므로, 여기 점수는 읽기 실력 확인용 참고 자료로만 활용해 주세요."),
      ("TOPIK Ⅰ은 누가 응시하나요?", "한국어 초급 학습자, 즉 기초 어휘·문법으로 일상적인 대화가 가능한 수준의 학습자를 대상으로 합니다."),
      ("그림이 있는 문제는 왜 빠져있나요?", "원본 기출문제 중 지도·표 등 이미지 기반 문제는 텍스트 퀴즈 형식으로 옮길 수 없어 제외했습니다."),
      ("오답 데이터는 어디에 저장되나요?", "모든 오답 데이터는 브라우저 로컬 스토리지에만 저장되며 서버로 전송되지 않습니다."),
    ],
  },
  # ── TOPIK Ⅱ (한국어능력시험 중고급) ─────────────────────
  {
    "file":     "exam-topik-2.html",
    "type":     "topik_2",
    "label":    "TOPIK Ⅱ",
    "count":    44,
    "icon":     "🇰🇷",
    "title":    "TOPIK Ⅱ 한국어능력시험 읽기 무료 모의고사 – 기출 44문항",
    "desc":     "TOPIK Ⅱ(한국어능력시험 중고급) 읽기 영역 무료 모의고사. 회원가입 없이 즉시 시작, 국립국제교육원 공식 기출문제(37~102회) 기반, 오답노트 제공.",
    "h1":       "TOPIK Ⅱ 읽기 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-topik-2.html",
    "badges":   ["🇰🇷 TOPIK Ⅱ", "📋 44문항 · 읽기", "⏱ 55분", "🏆 3~6급"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>TOPIK Ⅱ 읽기 영역 (중고급)</td></tr>
          <tr><th>문항 수</th><td>44문항 (4지선다, 그림 문제 일부 제외)</td></tr>
          <tr><th>급수 기준</th><td>3급 120 / 4급 150 / 5급 190 / 6급 230점↑ (300점 만점, 듣기+읽기+쓰기 합산)</td></tr>
          <tr><th>주관</th><td>국립국제교육원(NIIED)</td></tr>
          <tr><th>문제 출처</th><td>TOPIK 공식 기출문제 연습 서비스(37·41·47·52·60·64·83·91·96·102회)</td></tr>
        </table>
      </div>""",
    "faq": [
      ("이 모의고사로 실제 등급을 알 수 있나요?", "이 모의고사는 읽기 영역만 다룹니다. 실제 TOPIK Ⅱ 등급은 듣기·쓰기 영역과 합산한 점수(300점 만점)로 결정되므로, 여기 점수는 읽기 실력 확인용 참고 자료로만 활용해 주세요."),
      ("TOPIK Ⅱ은 누가 응시하나요?", "한국어 중급 이상 학습자, 대학 진학이나 한국 기업 취업을 준비하는 학습자가 주로 응시합니다."),
      ("그림이 있는 문제는 왜 빠져있나요?", "원본 기출문제 중 지도·표 등 이미지 기반 문제는 텍스트 퀴즈 형식으로 옮길 수 없어 제외했습니다."),
      ("오답 데이터는 어디에 저장되나요?", "모든 오답 데이터는 브라우저 로컬 스토리지에만 저장되며 서버로 전송되지 않습니다."),
    ],
  },
  # ── 한자능력검정 8급 ─────────────────────────────────────
  {
    "file":     "exam-hanja-8.html",
    "type":     "hanja_8",
    "label":    "한자능력검정 8급",
    "count":    56,
    "icon":     "🈴",
    "title":    "한자능력검정 8급 무료 모의고사 – 기출 변형 56문항",
    "desc":     "한자능력검정시험 8급 무료 모의고사. 회원가입 없이 즉시 시작, 배정한자 50자, 기출 문항 기반 4지선다, 오답노트 제공.",
    "h1":       "한자능력검정 8급 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-hanja-8.html",
    "badges":   ["🈴 8급", "📋 56문항", "⏱ 70분", "🈚 배정한자 50자"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>한자능력검정 8급 (4지선다)</td></tr>
          <tr><th>배정한자</th><td>50자</td></tr>
          <tr><th>문항 수</th><td>56문항</td></tr>
          <tr><th>주관</th><td>사단법인 한국어문회</td></tr>
          <tr><th>문제 출처</th><td>93·94회 기출문제 중 원래 선택지가 있던 문항만 4지선다로 재구성</td></tr>
        </table>
      </div>""",
    "faq": [
      ("문제가 기출 그대로인가요?", "정답과 오답 선택지는 모두 실제 기출문제의 보기에서 그대로 가져왔습니다. 다만 원본은 6~10개 보기 중 정답을 고르는 방식이라, 그중 정답 1개와 오답 3개만 골라 4지선다로 다시 구성했습니다."),
      ("서답형(주관식) 문제도 있나요?", "이번 버전에는 포함하지 않았습니다. 한자를 직접 쓰는 주관식 문항은 정답지가 따로 없어 정확도를 보장하기 어려워 제외했습니다."),
      ("8급은 어느 정도 수준인가요?", "한자능력검정시험 중 가장 기초 단계로, 一二三四五 같은 숫자와 東西南北, 父母兄弟 등 아주 기본적인 한자를 다룹니다."),
      ("오답 데이터는 어디에 저장되나요?", "모든 오답 데이터는 브라우저 로컬 스토리지에만 저장되며 서버로 전송되지 않습니다."),
    ],
  },
  # ── 한자능력검정 7급Ⅱ ───────────────────────────────────
  {
    "file":     "exam-hanja-7-2.html",
    "type":     "hanja_7_2",
    "label":    "한자능력검정 7급Ⅱ",
    "count":    32,
    "icon":     "🈴",
    "title":    "한자능력검정 7급Ⅱ 무료 모의고사 – 기출 변형 32문항",
    "desc":     "한자능력검정시험 7급Ⅱ 무료 모의고사. 회원가입 없이 즉시 시작, 배정한자 100자, 기출 문항 기반 4지선다, 오답노트 제공.",
    "h1":       "한자능력검정 7급Ⅱ 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-hanja-7-2.html",
    "badges":   ["🈴 7급Ⅱ", "📋 32문항", "⏱ 40분", "🈚 배정한자 100자"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>한자능력검정 7급Ⅱ (4지선다)</td></tr>
          <tr><th>배정한자</th><td>100자</td></tr>
          <tr><th>문항 수</th><td>32문항</td></tr>
          <tr><th>주관</th><td>사단법인 한국어문회</td></tr>
          <tr><th>문제 출처</th><td>93·94회 기출문제 중 원래 선택지가 있던 문항만 4지선다로 재구성</td></tr>
        </table>
      </div>""",
    "faq": [
      ("문제가 기출 그대로인가요?", "정답과 오답 선택지는 모두 실제 기출문제의 보기에서 그대로 가져왔습니다. 다만 원본은 6~10개 보기 중 정답을 고르는 방식이라, 그중 정답 1개와 오답 3개만 골라 4지선다로 다시 구성했습니다."),
      ("서답형(주관식) 문제도 있나요?", "이번 버전에는 포함하지 않았습니다. 한자를 직접 쓰는 주관식 문항은 정답지가 따로 없어 정확도를 보장하기 어려워 제외했습니다."),
      ("8급과 7급Ⅱ의 차이는?", "7급Ⅱ은 8급보다 배정한자가 두 배(100자)로 늘어난 다음 단계입니다."),
      ("오답 데이터는 어디에 저장되나요?", "모든 오답 데이터는 브라우저 로컬 스토리지에만 저장되며 서버로 전송되지 않습니다."),
    ],
  },
  # ── 한자능력검정 7급 ─────────────────────────────────────
  {
    "file":     "exam-hanja-7.html",
    "type":     "hanja_7",
    "label":    "한자능력검정 7급",
    "count":    32,
    "icon":     "🈴",
    "title":    "한자능력검정 7급 무료 모의고사 – 기출 변형 32문항",
    "desc":     "한자능력검정시험 7급 무료 모의고사. 회원가입 없이 즉시 시작, 배정한자 150자, 기출 문항 기반 4지선다, 오답노트 제공.",
    "h1":       "한자능력검정 7급 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-hanja-7.html",
    "badges":   ["🈴 7급", "📋 32문항", "⏱ 40분", "🈚 배정한자 150자"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>한자능력검정 7급 (4지선다)</td></tr>
          <tr><th>배정한자</th><td>150자</td></tr>
          <tr><th>문항 수</th><td>32문항</td></tr>
          <tr><th>주관</th><td>사단법인 한국어문회</td></tr>
          <tr><th>문제 출처</th><td>93·94회 기출문제 중 원래 선택지가 있던 문항만 4지선다로 재구성</td></tr>
        </table>
  ...
  # ── 한자능력검정 6급Ⅱ ───────────────────────────────────
  {
    "file":     "exam-hanja-6-2.html",
    "type":     "hanja_6_2",
    "label":    "한자능력검정 6급Ⅱ",
    "count":    8,
    "icon":     "🈴",
    "title":    "한자능력검정 6급Ⅱ 무료 모의고사 – 기출 변형 8문항",
    "desc":     "한자능력검정시험 6급Ⅱ 무료 모의고사. 회원가입 없이 즉시 시작, 배정한자 225자, 기출 문항 기반 4지선다, 오답노트 제공.",
    "h1":       "한자능력검정 6급Ⅱ 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-hanja-6-2.html",
    "badges":   ["🈴 6급Ⅱ", "📋 8문항", "⏱ 10분", "🈚 배정한자 225자"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>한자능력검정 6급Ⅱ (4지선다)</td></tr>
          <tr><th>배정한자</th><td>225자</td></tr>
          <tr><th>문항 수</th><td>8문항</td></tr>
          <tr><th>주관</th><td>사단법인 한국어문회</td></tr>
          <tr><th>문제 출처</th><td>93·94회 기출문제 중 원래 선택지가 있던 문항만 4지선다로 재구성</td></tr>
        </table>
      </div>""",
    "faq": [
      ("왜 문항 수가 적나요?", "6급Ⅱ부터는 원본 시험이 한자를 직접 쓰는 주관식 비중이 커져서, 정답지 없이도 정확도를 보장할 수 있는(이미 선택지가 있던) 문항만 골라내다 보니 수가 적습니다. 자료를 더 확보하면 늘려갈 예정입니다."),
      ("문제가 기출 그대로인가요?", "정답과 오답 선택지는 모두 실제 기출문제의 보기에서 그대로 가져왔습니다."),
      ("오답 데이터는 어디에 저장되나요?", "모든 오답 데이터는 브라우저 로컬 스토리지에만 저장되며 서버로 전송되지 않습니다."),
    ],
  },
  # ── 한자능력검정 6급 ─────────────────────────────────────
  {
    "file":     "exam-hanja-6.html",
    "type":     "hanja_6",
    "label":    "한자능력검정 6급",
    "count":    24,
    "icon":     "🈴",
    "title":    "한자능력검정 6급 무료 모의고사 – 기출 변형 24문항",
    "desc":     "한자능력검정시험 6급 무료 모의고사. 회원가입 없이 즉시 시작, 배정한자 300자, 기출 문항 기반 4지선다, 오답노트 제공.",
    "h1":       "한자능력검정 6급 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-hanja-6.html",
    "badges":   ["🈴 6급", "📋 24문항", "⏱ 30분", "🈚 배정한자 300자"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>한자능력검정 6급 (4지선다)</td></tr>
          <tr><th>배정한자</th><td>300자</td></tr>
          <tr><th>문항 수</th><td>24문항</td></tr>
          <tr><th>주관</th><td>사단법인 한국어문회</td></tr>
          <tr><th>문제 출처</th><td>93·94회 기출문제 중 원래 선택지가 있던 문항만 4지선다로 재구성</td></tr>
        </table>
      </div>""",
  ...
  # ── 한자능력검정 5급Ⅱ ───────────────────────────────────
  {
    "file":     "exam-hanja-5-2.html",
    "type":     "hanja_5_2",
    "label":    "한자능력검정 5급Ⅱ",
    "count":    32,
    "icon":     "🈴",
    "title":    "한자능력검정 5급Ⅱ 무료 모의고사 – 기출 변형 32문항",
    "desc":     "한자능력검정시험 5급Ⅱ 무료 모의고사. 회원가입 없이 즉시 시작, 배정한자 400자, 기출 문항 기반 4지선다, 오답노트 제공.",
    "h1":       "한자능력검정 5급Ⅱ 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-hanja-5-2.html",
    "badges":   ["🈴 5급Ⅱ", "📋 32문항", "⏱ 40분", "🈚 배정한자 400자"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>한자능력검정 5급Ⅱ (4지선다)</td></tr>
          <tr><th>배정한자</th><td>400자</td></tr>
          <tr><th>문항 수</th><td>32문항</td></tr>
          <tr><th>주관</th><td>사단법인 한국어문회</td></tr>
          <tr><th>문제 출처</th><td>93·94회 기출문제 중 원래 선택지가 있던 문항만 4지선다로 재구성</td></tr>
        </table>
  ...
  # ── 한자능력검정 5급 ─────────────────────────────────────
  {
    "file":     "exam-hanja-5.html",
    "type":     "hanja_5",
    "label":    "한자능력검정 5급",
    "count":    26,
    "icon":     "🈴",
    "title":    "한자능력검정 5급 무료 모의고사 – 기출 변형 26문항",
    "desc":     "한자능력검정시험 5급 무료 모의고사. 회원가입 없이 즉시 시작, 배정한자 500자, 기출 문항 기반 4지선다, 오답노트 제공.",
    "h1":       "한자능력검정 5급 모의고사",
    "canonical":"https://wooagosa.wooahouse.com/exam-hanja-5.html",
    "badges":   ["🈴 5급", "📋 26문항", "⏱ 33분", "🈚 배정한자 500자"],
    "info": """<div class="exam-info-box">
        <h2 class="section-title">시험 안내</h2>
        <table class="info-table">
          <tr><th>시험 유형</th><td>한자능력검정 5급 (4지선다)</td></tr>
          <tr><th>배정한자</th><td>500자</td></tr>
          <tr><th>문항 수</th><td>26문항</td></tr>
          <tr><th>주관</th><td>사단법인 한국어문회</td></tr>
          <tr><th>문제 출처</th><td>93·94회 기출문제 중 원래 선택지가 있던 문항만 4지선다로 재구성</td></tr>
        </table>
      </div>""",
    "faq": [
      ("문제가 기출 그대로인가요?", "정답과 오답 선택지는 모두 실제 기출문제의 보기에서 그대로 가져왔습니다. 다만 원본은 6~10개 보기 중 정답을 고르는 방식이라, 그중 정답 1개와 오답 3개만 골라 4지선다로 다시 구성했습니다."),
      ("서답형(주관식) 문제도 있나요?", "이번 버전에는 포함하지 않았습니다. 한자를 직접 쓰는 주관식 문항은 정답지가 따로 없어 정확도를 보장하기 어려워 제외했습니다."),
      ("특급·1급 같은 고급 급수는 왜 없나요?", "고급 급수는 원본 시험 자체가 거의 전부 한자를 직접 쓰는 주관식이고, 정답지도 따로 없어 정확도를 보장하기 어려워 이번엔 제외했습니다."),
      ("오답 데이터는 어디에 저장되나요?", "모든 오답 데이터는 브라우저 로컬 스토리지에만 저장되며 서버로 전송되지 않습니다."),
    ],
  },
]
...
{ERROR_PREVENTION_TAG}
  <style>
    ...
    .gp-modal-card .gp-icon {{ font-size: 2.2rem; margin-bottom: .5rem; }}
    .gp-modal-card h3 {{ font-size: 1.05rem; color: var(--navy); margin-bottom: .4rem; }}
    .gp-modal-card p {{ font-size: .85rem; color: var(--text-mid); margin-bottom: 1.25rem; line-height: 1.5; }}
    .gp-modal-btns {{ display: flex; flex-direction: column; gap: .6rem; }}
    .gp-modal-btn {{
    ...
    .gp-modal-btn-primary {{ background: var(--blue); color: #fff; }}
    .gp-modal-btn-primary:hover {{ opacity: .9; }}
    .gp-modal-btn-secondary {{ background: var(--bg); color: var(--text-mid); border: 1.5px solid var(--border); }}
    .gp-modal-btn-secondary:hover {{ border-color: var(--blue); color: var(--blue); }}
  </style>
</head>
<body>

<div class="gp-modal-overlay" id="gpModal">

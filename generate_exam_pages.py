...
EXAMS = [
  ...
  # ── 네트워크관리사 ───────────────────────────────────────
  {
    ...
    "count":    60,
    "icon":     "🌐",
    "title":    "네트워크관리사 1급 필기 모의고사 무료",
    "desc":     "네트워크관리사 1급 필기 무료 모의고사. TCP/IP·NOS·정보보호 등 5과목, 기출 364문제, 60문항 랜덤 출제, 오답노트·타이머 제공.",
  ...
  },
  {
    ...
    "count":    50,
    "icon":     "🌐",
    "title":    "네트워크관리사 2급 필기 모의고사 무료",
    "desc":     "네트워크관리사 2급 필기 무료 모의고사. TCP/IP·NOS 등 4과목, 기출 262문제, 50문항 랜덤 출제, 오답노트·타이머 제공. 회원가입 없이 바로 시작.",
  ...
  # ── 리눅스마스터 ─────────────────────────────────────────
  {
    ...
    "count":    100,
    "icon":     "🐧",
    "title":    "리눅스마스터 1급 필기 모의고사 무료",
    "desc":     "리눅스마스터 1급 필기 무료 모의고사. 리눅스 실무·시스템관리·네트워크 3과목, 기출 984문제, 100문항 출제, 오답노트·타이머 제공.",
  ...
  },
  {
    ...
    "count":    80,
    "icon":     "🐧",
    "title":    "리눅스마스터 2급 필기 모의고사 무료",
    "desc":     "리눅스마스터 2급 필기 무료 모의고사. 리눅스 운영·활용 2과목, 기출 845문제, 80문항 랜덤 출제, 오답노트·타이머 제공. 회원가입 없이 바로 시작.",
  ...
  # ── 워드프로세서 ─────────────────────────────────────────
  {
    ...
    "count":    60,
    "icon":     "📝",
    "title":    "워드프로세서 필기 모의고사 무료 – 대한상공회의소 기출",
    "desc":     "워드프로세서 필기 무료 모의고사. 워드프로세싱일반·PC운영체제·컴퓨터정보활용 3과목, 기출 617문제, 60문항 출제, 오답노트 제공.",
    "h1":       "워드프로세서 필기 모의고사",
  ...
  # ── 전기기사 / 전기산업기사 ──────────────────────────────
  {
    ...
    "count":    100,
    "icon":     "⚡",
    "title":    "전기기사 필기 모의고사 무료 – 기출문제 462문제",
    "desc":     "전기기사 필기 무료 모의고사. 전기자기학·전력공학·전기기기·회로이론·전기설비기술기준 5과목, 기출 462문제, 100문항 출제, 오답노트 제공.",
    "h1":       "전기기사 필기 모의고사",
  ...
  },
  {
    ...
    "count":    100,
    "icon":     "⚡",
    "title":    "전기산업기사 필기 모의고사 무료 – 기출문제 539문제",
    "desc":     "전기산업기사 필기 무료 모의고사. 전기자기학·전력공학·전기기기·회로이론·전기설비 5과목, 기출 539문제, 100문항 출제, 오답노트 제공.",
    "h1":       "전기산업기사 필기 모의고사",
  ...
  # ── 정보처리기사 / 정보처리산업기사 ──────────────────────
  {
    ...
    "count":    100,
    "icon":     "🖥️",
    "title":    "정보처리기사 필기 모의고사 무료 – 기출문제 692문제",
    "desc":     "정보처리기사 필기 무료 모의고사. 데이터베이스·전자계산기·운영체제·소프트웨어공학·데이터통신 5과목, 기출 692문제, 100문항 출제, 오답노트 제공.",
    "h1":       "정보처리기사 필기 모의고사",
  ...
  },
  {
    ...
    "count":    100,
    "icon":     "🖥️",
    "title":    "정보처리산업기사 필기 모의고사 무료 – 기출문제 309문제",
    "desc":     "정보처리산업기사 필기 무료 모의고사. 데이터베이스·전자계산기·시스템분석·운영체제·정보통신 5과목, 기출 309문제, 100문항 출제, 오답노트 제공.",
    "h1":       "정보처리산업기사 필기 모의고사",
  ...
  # ── 정보보안기사 ─────────────────────────────────────────
  {
    ...
    "count":    100,
    "icon":     "🔒",
    "title":    "정보보안기사 필기 모의고사 무료 – 기출문제 822문제",
    "desc":     "정보보안기사 필기 무료 모의고사. 시스템보안·네트워크보안·어플리케이션보안·정보보안일반·법규 5과목, 기출 822문제, 100문항 출제, 오답노트 제공.",
    "h1":       "정보보안기사 필기 모의고사",
